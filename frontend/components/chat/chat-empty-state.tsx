      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-md">
        {CHAT_SUGGESTIONS.map((suggestion) => (
          <button
            ...
            className="text-left p-3 rounded-lg border border-border hover:bg-muted hover:border-blue-500 transition-colors text-sm font-medium text-foreground cursor-pointer"
          >
            {suggestion}
          </button>
        ))}
